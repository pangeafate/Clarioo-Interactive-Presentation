...
export default function Slide12WhyNow() {
  return (
    <div className="pdf-slide" style={{ padding: '6rem' }}>
      ...
      <div className="glass-card" style={{ marginTop: '5rem', display: 'flex', justifyContent: 'space-between', fontWeight: 700, alignItems: 'center', maxWidth: '1100px', margin: '5rem auto 0' }}>
